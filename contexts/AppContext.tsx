...
const initialState: AppState = {
    ...
    bookings: [],
    searchResults: [],
    favoriteProviderIds: JSON.parse(localStorage.getItem('favoriteProviderIds') || '[]'),
...
const appReducer = (state: AppState, action: Action): AppState => {
    switch (action.type) {
        ...
        case 'TOGGLE_FAVORITE': {
            ...
            localStorage.setItem('favoriteProviderIds', JSON.stringify(newFavorites));
            return {
                ...state,
                favoriteProviderIds: newFavorites,
            };
        }
        case 'OPEN_MODAL':
